...
export const ITEMS: Item[] = [
    ...
    { ID: 3, title: 'Broken vase', ownerID: 1, forSale: true, weight: 30, price: 40, type: ItemType.GLASS, path: 'a' },
    { ID: 4, title: 'Metal shavings', ownerID: 4, forSale: true, weight: 40, price: 60, type: ItemType.METAL, path: 'b' },
];
